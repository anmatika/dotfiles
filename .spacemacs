...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(circe)
...
you should place your code here."
  ...
  (global-company-mode)
  (golden-ratio-mode 1)
  (add-to-list 'yas-snippet-dirs "/home/antti/code/yasnippet-snippets")
  (yas-global-mode t)
